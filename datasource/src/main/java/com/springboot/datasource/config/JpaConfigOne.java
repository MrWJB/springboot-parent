...
@EnableJpaRepositories(basePackages = "com.springboot.datasource.dao1",entityManagerFactoryRef = "entityManagerFactoryBeanOne",
...
public class JpaConfigOne {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactoryBeanOne(EntityManagerFactoryBuilder builder){
        return builder.dataSource(dsOne)
                    ...
                    .packages("com.springboot.datasource.model")
                    .persistenceUnit("pu1")
                    .build();
    }
