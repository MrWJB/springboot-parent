...
@EnableJpaRepositories(basePackages = "com.springboot.datasource.dao2",entityManagerFactoryRef = "entityManagerFactoryBeanTwo",
...
public class JpaConfigTwo {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactoryBeanTwo(EntityManagerFactoryBuilder builder){
        return builder.dataSource(dsTwo)
                    ...
                    .packages("com.springboot.datasource.domain")
                    .persistenceUnit("pu2")
                    .build();
    }
